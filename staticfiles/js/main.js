...
$(document).ready(function() {
	var low = document.getElementById('id_price_gt')
	var high =  document.getElementById('id_price_lt')
	...
	$("#price-range").slider({
		...
		slide: function( event, ui ) {
			...
			low.value = ui.values[ 0 ];
			high.value = ui.values[ 1 ];
	...
	low.value = $( "#price-range" ).slider( "values", 0 );
	high.value = $( "#price-range" ).slider( "values", 1 );
